...
public:
     ...
     */
    void RunJavaCode(const char* name, App42Object *jsonBody, const app42CallBack& pSelector);
     ...
     *            - Request Body in JSON format
     */
    void RunJavaCode(const char* name, const char* jsonString, const app42CallBack& pSelector);
