...
public:
     ...
     *
     */
	void CreateReward(const char* rewardName,const char* description, const app42CallBack& pSelector);
	/**
     ...
     *
     */
	void GetAllRewards(const app42CallBack& pSelector);
    /**
     ...
     *
     */
    void GetAllRewards(int max, int offset, const app42CallBack& pSelector);
     ...
     *
     */
	void GetAllRewardsCount(const app42CallBack& pSelector);
	/**
     ...
     *
     */
	void EarnRewards(const char* gameName, const char* userName, const char* rewardName, double rewardPoints,const app42CallBack& pSelector);
	/**
     ...
     *
     */
	void RedeemRewards(const char* gameName, const char* userName, const char* rewardName, double rewardPoints,const app42CallBack& pSelector);
	/**
     ...
     * 
     */
	void GetGameRewardPointsForUser(const char* gameName, const char* userName, const app42CallBack& pSelector);
     ...
     *
     */
     void GetRewardByName(const char* rewardName, const app42CallBack& pSelector);
     ...
     */
    void GetTopNRewardEarners(const char* gameName, const char* rewardName, int max, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetAllRewardsByUser(const char* userName, const char* rewardName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetTopNRewardEarnersByGroup(const char* gameName, const char* rewardName, vector<std::string>userList, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetUserRankingOnReward(const char* gameName, const char* rewardName, const char* userName, const app42CallBack& pSelector);
