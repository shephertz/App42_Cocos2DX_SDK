...
public:
     ...
     *
     */
	void CreateGame(const char* gameName,const char* description, const app42CallBack& pSelector);
     ...
     *
     */
	void GetGamebyName(const char* gameName,const app42CallBack& pSelector);
     ...
     *
     */
	void GetAllGames(const app42CallBack& pSelector);
     ...
     *
     */
	void GetAllGames(int max, int offset, const app42CallBack& pSelector);
     ...
     *
     */
	void GetAllGamesCount(const app42CallBack& pSelector);
