...
private:
    ...
    string buildUpdateAvatarRequest(const char* userName, const char* avatarName, const char* newAvatarName, const char* description);
...
public:
     ...
     */
    void CreateAvatar(const char* avatarName, const char* userName, const char* filePath, const char* description, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void CreateAvatar(const char* avatarName, const char* userName, unsigned char* fileData, int fileDataSize, const char* description,FileExtension extension, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void CreateAvatarFromFacebook(const char* avatarName, const char* userName, const char* accessToken, const char* description, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void CreateAvatarFromWebURL(const char* avatarName, const char* userName, const char* webUrl, const char* description, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetAvatarByName(const char* avatarName, const char* userName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetAllAvatars(const char* userName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetCurrentAvatar(const char* userName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void ChangeCurrentAvatar(const char* avatarName, const char* userName, const app42CallBack& pSelector);
    
    /**
     * Update your current avatar from existing avatars in app.
     *
     * @param userName
     *            - Name of the user for which avatar is to updated.
     * @param avatarName
     ...
     * @throws App42Exception
     */
    void UpdateAvatar(const char* avatarName, const char* userName, const char* newAvatarName, const char* description, const app42CallBack& pSelector);
    
    /**
     * Delete specified avatar of user in app.
     *
     * @param userName
     *            - Name of the user for which avatar is to updated.
     * @param avatarName
     ...
     * @throws App42Exception
     */
    void DeleteAvatarByName(const char* avatarName, const char* userName, const app42CallBack& pSelector);
    
    /**
     * Delete all avatars of a user in app.
     *
     * @param userName
     *            - Name of the user for which avatar is to updated.
     *
     ...
     * @throws App42Exception
     */
    void DeleteAllAvatars(const char* userName, const app42CallBack& pSelector);
};
