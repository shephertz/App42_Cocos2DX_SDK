...
//    static void throwExceptionIfTargetIsNull(cocos2d::Object *obj, string name)
//    {
//		if(obj==NULL)
//        {
//			throw new App42Exception(name + ": parameter can not be null ",0,0);
...
//	}
    ...
    static void throwExceptionIfCallBackIsNull(SEL_App42CallFuncND pSelector, string name)
    {
		if(pSelector==NULL)
        {
			throw new App42Exception(name + ": parameter can not be null ",0,0);
