...
void CustomCodeService::RunJavaCode(const char* name, App42Object *jsonBody,SEL_App42CallFuncND pSelector)
{
     ...
     */
    Util::executePost(encodedUrl, headers, jsonBody->toString().c_str(), std::bind(&App42CustomCodeResponse::onComplete,response,std::placeholders::_1,std::placeholders::_2));
