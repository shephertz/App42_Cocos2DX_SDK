...
public:
     ...
     *
     */
    void GetSession(const char* userName, const app42CallBack& pSelector);
     ...
     *
     */
    void GetSession(const char* userName, bool isCreate, const app42CallBack& pSelector);
     ...
     *
     */
    void Invalidate(const char* sessionId, const app42CallBack& pSelector);
     ...
     *
     */
    void SetAttribute(const char* sessionId, const char* attributeName, const char* attributeValue, const app42CallBack& pSelector);
     ...
     *
     */
    void GetAttribute(const char* sessionId, const char* attributeName, const app42CallBack& pSelector);
     ...
     *
     */
    void GetAllAttributes(const char* sessionId, const app42CallBack& pSelector);
     ...
     *
     */
    void RemoveAttribute(const char* sessionId, const char* attributeName, const app42CallBack& pSelector);
     ...
     *
     */
    void RemoveAllAttributes(const char* sessionId, const app42CallBack& pSelector);
