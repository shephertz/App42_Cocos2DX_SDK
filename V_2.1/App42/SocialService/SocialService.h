...
public:
     ...
     *
     */
    void LinkUserFacebookAccount(const char *userName, const char *accessToken, const char *appId, const char *appSecret, const app42CallBack& pSelector);
     ...
     *
     */
    void LinkUserFacebookAccount(const char *userName, const char *accessToken, const app42CallBack& pSelector);
     ...
     *
     */
    void UpdateFacebookStatus(const char *userName, const char *status, const app42CallBack& pSelector);
     ...
     */
    void GetFacebookFriendsFromLinkUser(const char *userName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetFacebookFriendsFromAccessToken(const char *accessToken, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void FacebookPublishStream(const char *accessToken, const char *fileName, const char *filePath, const char *message, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void FacebookLinkPost(const char* accessToken, const char* link, const char* message, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void FacebookLinkPostWithCustomThumbnail(const char* accessToken, const char* link, const char* message,const char* pictureUrl, const char* fileName, const char* description, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetFacebookProfile(const char* accessToken, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetFacebookProfilesFromIds(vector<string> facebookIds, const app42CallBack& pSelector);
     ...
     * @returns The App42SocialResponse object
     */
    void LinkUserTwitterAccount(const char* userName, const char* consumerKey, const char*consumerSecret, const char* accessToken, const char* accessTokenSecret, const app42CallBack& pSelector);
     ...
     *
     */
    void LinkUserTwitterAccount(const char* userName, const char* accessToken, const char* accessTokenSecret, const app42CallBack& pSelector);
     ...
     * @returns The App42SocialResponse object
     */
    void UpdateTwitterStatus(const char* userName, const char* status, const app42CallBack& pSelector);
     ...
     *
     */
    void LinkUserLinkedInAccount(const char* userName, const char* linkedInApiKey, const char* linkedInSecretKey, const char* accessToken, const char* accessTokenSecret, const app42CallBack& pSelector);
     ...
     *
     */
    void LinkUserLinkedInAccount(const char* userName, const char* accessToken, const char* accessTokenSecret, const app42CallBack& pSelector);
     ...
     *
     */
    void UpdateLinkedInStatus(const char* userName, const char* status, const app42CallBack& pSelector);
    /**
     ...
     *
     */
    void UpdateSocialStatusForAll(const char* userName, const char* status, const app42CallBack& pSelector);
