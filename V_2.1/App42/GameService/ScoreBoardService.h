...
public:
     ...
     *
     */
	void SaveUserScore(const char* gameName,const char* userName, double score, const app42CallBack& pSelector);
     ...
     *
     */
    void EditScoreValueById(const char* scoreId, double gameScore, const app42CallBack& pSelector);
     ...
     *
     */
	void GetAverageScoreByUser(const char* gameName, const char* userName, const app42CallBack& pSelector);
     ...
     *
     */
	void GetHighestScoreByUser(const char* gameName,const char* userName , const app42CallBack& pSelector);
     ...
     *
     */
	void GetLastScoreByUser(const char* gameName,const char* userName,const app42CallBack& pSelector);
	/**
     ...
     *
     */
	void GetTopRankings(const char* gameName,const app42CallBack& pSelector);
     ...
     *
     */
	void GetTopRankings(const char* gameName, tm *startDate, tm *endDate,const app42CallBack& pSelector);
     ...
     *
     */
	void GetUserRanking(const char* gameName, const char* userName,const app42CallBack& pSelector);
     ...
     *
     */
    void GetTopNRankers(const char* gameName,int max,const app42CallBack& pSelector);
     ...
     *
     */
    void GetTopNRankers(const char* gameName, tm *startDate, tm *endDate, int max, const app42CallBack& pSelector);
    ...
    void GetScoresByUser(const char* gameName,const char* userName,const app42CallBack& pSelector);
     ...
     *
     */
    void GetLowestScoreByUser(const char* gameName,const char* userName,const app42CallBack& pSelector);
     ...
     *
     */
    void GetTopRankingsByGroup(const char* gameName,std::vector<std::string>group,const app42CallBack& pSelector);
     ...
     *
     */
    void GetTopRankersByGroup(const char* gameName,std::vector<std::string>group,const app42CallBack& pSelector);
    ...
    void GetLastGameScore(const char* userName,const app42CallBack& pSelector);
     ...
     */
    void GetTopNTargetRankers(const char* gameName,int max,const app42CallBack& pSelector);
     ...
     *
     */
    void GetTopNRankings(const char* gameName,int max,const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetUsersWithScoreRange(const char* gameName,double minScore, double maxScore,const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
    void GetTopNRankersFromFacebook(const char* gameName, const char* fbAccessToken, int max, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetTopNRankersFromFacebook(const char* gameName, const char* fbAccessToken, tm *startDate, tm *endDate, int max, const app42CallBack& pSelector);
