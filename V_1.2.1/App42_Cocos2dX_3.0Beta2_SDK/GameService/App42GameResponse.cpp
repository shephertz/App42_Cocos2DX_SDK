...
App42GameResponse::App42GameResponse(cocos2d::Object *pTarget, cocos2d::SEL_CallFuncND pSelector)
...
void App42GameResponse::onComplete(cocos2d::Node *sender, void *data)
{
