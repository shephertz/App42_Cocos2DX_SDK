...
void GameService::CreateGame(string gameName,string description, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    ...
    Util::executePost(baseUrl, headers, createGamebody.c_str(), response, httpresponse_selector(App42GameResponse::onComplete));
}

void GameService::GetGamebyName(string gameName,Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void GameService::GetAllGames(Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
