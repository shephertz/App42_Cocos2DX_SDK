...
public:
     ...
     *
     */
	void SaveUserScore(string gameName,string userName, double score, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     *
     */
    void EditScoreValueById(string scoreId, double gameScore, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     *
     */
	void GetAverageScoreByUser(string gameName, string userName, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     *
     */
	void GetHighestScoreByUser(string gameName,string userName , cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     *
     */
	void GetLastScoreByUser(string gameName,string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
	/**
     ...
     *
     */
	void GetTopRankings(string gameName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
	/**
     ...
     *
     */
	void GetUserRanking(string gameName, string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     *
     */
    void GetTopNRankers(string gameName,int max,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
    ...
    void GetScoresByUser(string gameName,string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     *
     */
    void GetLowestScoreByUser(string gameName,string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     *
     */
    void GetTopRankersByGroup(string gameName,std::vector<std::string>group,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
    ...
    void GetLastGameScore(string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
    
    void GetTopNTargetRankers(string gameName,int max,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
