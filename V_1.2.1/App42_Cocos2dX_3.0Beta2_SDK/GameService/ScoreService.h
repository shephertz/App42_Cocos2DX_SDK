...
class ScoreService: public App42Service, public cocos2d::Node
{
private:
...
public:
	...
	void AddScore(string gameName, string userName, double score, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
	/**
     ...
     *
     */
	void DeductScore(string gameName, string userName, double score, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
