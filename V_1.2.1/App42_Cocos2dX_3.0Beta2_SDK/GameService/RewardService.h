...
using namespace std;
class RewardService: public App42Service, public cocos2d::Node
{
private:
...
public:
     ...
     *
     */
	void CreateReward(string rewardName,string description, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
	/**
     ...
     *
     */
	void GetAllRewards(cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
	/**
     ...
     *
     */
	void EarnRewards(string gameName, string userName, string rewardName, double rewardPoints,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
	/**
     ...
     *
     */
	void RedeemRewards(string gameName, string userName, string rewardName, double rewardPoints,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
	/**
     ...
     * 
     */
	void GetGameRewardPointsForUser(string gameName, string userName, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
};
