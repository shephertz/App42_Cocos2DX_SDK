...
void ScoreService::DeductScore(string gameName, string userName, double score, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
    ...
    Util::executePost(baseUrl, headers, deductScoreBody.c_str(), response, httpresponse_selector(App42GameResponse::onComplete));
}
