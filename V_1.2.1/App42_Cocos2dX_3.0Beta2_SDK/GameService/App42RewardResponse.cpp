...
App42RewardResponse::App42RewardResponse(cocos2d::Object *pTarget, cocos2d::SEL_CallFuncND pSelector)
...
void App42RewardResponse::onComplete(cocos2d::Node *sender, void *data)
{
