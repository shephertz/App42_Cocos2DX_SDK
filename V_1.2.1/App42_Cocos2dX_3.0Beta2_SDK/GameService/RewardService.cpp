...
void RewardService::CreateReward(string rewardName,string description, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
...
void RewardService::GetAllRewards(cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42RewardResponse *response = new App42RewardResponse::App42RewardResponse(pTarget,pSelector);
...
void RewardService::EarnRewards(string gameName, string userName, string rewardName, double rewardPoints,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42RewardResponse *response = new App42RewardResponse::App42RewardResponse(pTarget,pSelector);
...
void RewardService::RedeemRewards(string gameName, string userName, string rewardName, double rewardPoints,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42RewardResponse *response = new App42RewardResponse::App42RewardResponse(pTarget,pSelector);
...
void RewardService::GetGameRewardPointsForUser(string gameName, string userName, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42RewardResponse *response = new App42RewardResponse::App42RewardResponse(pTarget,pSelector);
