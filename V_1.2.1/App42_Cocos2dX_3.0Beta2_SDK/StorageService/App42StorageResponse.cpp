...
App42StorageResponse::App42StorageResponse(cocos2d::Object *pTarget, cocos2d::SEL_CallFuncND pSelector)
...
void App42StorageResponse::onComplete(cocos2d::Node *sender, void *data)
{
