...
void PushNotificationService::registerDeviceToken(string deviceToken, string userName, string deviceType, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    ...
    Util::executePost(baseUrl, headers, pushBody.c_str(), response, httpresponse_selector(App42PushNotificationResponse::onComplete));
    
}

void PushNotificationService::sendPushMessageToUser(string username,  string message, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42PushNotificationResponse *response = new App42PushNotificationResponse::App42PushNotificationResponse(pTarget,pSelector);
...
void PushNotificationService::sendPushMessageToUser(string username, map<string, string>messageMap, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42PushNotificationResponse *response = new App42PushNotificationResponse::App42PushNotificationResponse(pTarget,pSelector);
...
void PushNotificationService::subscribeToChannel(string channel, string userName, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42PushNotificationResponse *response = new App42PushNotificationResponse::App42PushNotificationResponse(pTarget,pSelector);
...
void PushNotificationService::sendPushMessageToChannel(string channel, string message, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42PushNotificationResponse *response = new App42PushNotificationResponse::App42PushNotificationResponse(pTarget,pSelector);
    ...
    string baseUrl = getBaseUrl(resource);
    baseUrl.append("?");
    const char *encodedUrl = Util::url_encode(baseUrl);
    //Util::app42Trace("\n baseUrl = %s",baseUrl.c_str());
    //Util::app42Trace("\n addScoreBody = %s",pushBody.c_str());
...
void PushNotificationService::sendPushMessageToChannel(string channel, map<string, string>messageMap, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42PushNotificationResponse *response = new App42PushNotificationResponse::App42PushNotificationResponse(pTarget,pSelector);
