...
class UserService : public App42Service, public cocos2d::Node
{
...
public:
     ...
     *
     */
	void CreateUser(string username, string password, string email,Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
	/**
     ...
     * @return app42Result - The result of the request
     */
	void Authenticate(string userName, string password, Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     * @return app42Result - The result of the request.
     */
	void GetUser(string username, Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
	/**
     * Gets the details of all users
     * 
     * @return app42Result - The result of the request.
     */
	void GetAllUsers(Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
};
