...
void TimerService::CreateOrUpdateTimer(const char* timerName, long timeInSeconds,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42TimerResponse *response = new App42TimerResponse(pTarget,pSelector);
     ...
     */
    Util::executePost(encodedUrl, headers, body.c_str(), response, app42response_selector(App42TimerResponse::onComplete));
}

void TimerService::StartTimer(const char* timerName, const char* userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42TimerResponse *response = new App42TimerResponse(pTarget,pSelector);
...
void TimerService::CancelTimer(const char* timerName, const char* userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42TimerResponse *response = new App42TimerResponse(pTarget,pSelector);
     ...
     * Initiating Http call
     */
    Util::executeDelete(encodedUrl, headers, response, app42response_selector(App42TimerResponse::onComplete));
}

void TimerService::IsTimerActive(const char* timerName, const char* userName,App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42TimerResponse *response = new App42TimerResponse(pTarget,pSelector);
...
void TimerService::DeleteTimer(const char* timerName, App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42TimerResponse *response = new App42TimerResponse(pTarget,pSelector);
...
void TimerService::GetCurrentTime(App42CallBack* pTarget, SEL_App42CallFuncND pSelector)
{
    App42TimerResponse *response = new App42TimerResponse(pTarget,pSelector);
     ...
     * Initiating Http call
     */
    Util::executeGet(encodedUrl, headers, response, app42response_selector(App42TimerResponse::onComplete));
}
