...
namespace App42
{
	...
	public:
		...
		void CreateOrUpdateTimer(const char* timerName, long timeInSeconds,  SEL_App42CallFuncND pSelector);

		void StartTimer(const char* timerName, const char* userName,  SEL_App42CallFuncND pSelector);

		/*New APIs*/
		void CancelTimer(const char* timerName, const char* userName,  SEL_App42CallFuncND pSelector);

		void IsTimerActive(const char* timerName, const char* userName,  SEL_App42CallFuncND pSelector);

		void DeleteTimer(const char* timerName,  SEL_App42CallFuncND pSelector);

		void GetCurrentTimeNoWinBase(SEL_App42CallFuncND pSelector);
	};
}
