...
App42PushNotificationResponse::App42PushNotificationResponse(cocos2d::Object *pTarget, cocos2d::SEL_CallFuncND pSelector)
...
void App42PushNotificationResponse::onComplete(cocos2d::Node *sender, void *data)
{
    ...
    {
        (_pTarget->*_pSelector)((cocos2d::Node *)_pTarget, this);
    }
