...
void StorageService::InsertJsonDocument(string dbName, string collectionName, string json, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
...
void StorageService::FindAllCollections(string dbName, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42StorageResponse *response = new App42StorageResponse::App42StorageResponse(pTarget,pSelector);
...
void StorageService::FindAllDocuments(string dbName, string collectionName, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42StorageResponse *response = new App42StorageResponse::App42StorageResponse(pTarget,pSelector);
...
void StorageService::FindDocumentById(string dbName, string collectionName, string docId, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42StorageResponse *response = new App42StorageResponse::App42StorageResponse(pTarget,pSelector);
...
void StorageService::FindDocumentByQuery(string dbName, string collectionName, Query *query, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42StorageResponse *response = new App42StorageResponse::App42StorageResponse(pTarget,pSelector);
...
void StorageService::FindDocumentByKeyValue(string dbName, string collectionName, string key,string value, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42StorageResponse *response = new App42StorageResponse::App42StorageResponse(pTarget,pSelector);
...
void StorageService::UpdateDocumentByDocId(string dbName, string collectionName, string docId,string json, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42StorageResponse *response = new App42StorageResponse::App42StorageResponse(pTarget,pSelector);
...
void StorageService::UpdateDocumentByKeyValue(string dbName, string collectionName, string key,string value,string json, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42StorageResponse *response = new App42StorageResponse::App42StorageResponse(pTarget,pSelector);
...
void StorageService::SaveOrUpdateDocumentByKeyValue(string dbName, string collectionName, string key,string value,string json, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42StorageResponse *response = new App42StorageResponse::App42StorageResponse(pTarget,pSelector);
...
void StorageService::DeleteDocumentsById(string dbName, string collectionName, string docId, Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42StorageResponse *response = new App42StorageResponse::App42StorageResponse(pTarget,pSelector);
