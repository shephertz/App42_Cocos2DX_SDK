...
void ScoreBoardService::SaveUserScore(string gameName,string userName, double score, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    ...
    Util::executePost(baseUrl, headers, saveScoreBody.c_str(), response, httpresponse_selector(App42GameResponse::onComplete));

}

void ScoreBoardService::EditScoreValueById(string scoreId, double gameScore, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
    ...
    Util::executePut(baseUrl, headers, saveScoreBody.c_str(), response, httpresponse_selector(App42GameResponse::onComplete));
    
}

void ScoreBoardService::GetAverageScoreByUser(string gameName, string userName, cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    ...
    Util::executeGet(url,headers, response, httpresponse_selector(App42GameResponse::onComplete));

}

void ScoreBoardService::GetHighestScoreByUser(string gameName,string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetLastScoreByUser(string gameName,string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetTopRankings(string gameName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetTopNRankers(string gameName,int max,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetUserRanking(string gameName, string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetScoresByUser(string gameName,string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
...
void ScoreBoardService::GetLowestScoreByUser(string gameName,string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetTopRankersByGroup(string gameName,std::vector<std::string>group,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetLastGameScore(string userName,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
...
void ScoreBoardService::GetTopNTargetRankers(string gameName,int max,cocos2d::Object* pTarget, cocos2d::SEL_CallFuncND pSelector)
{
    App42GameResponse *response = new App42GameResponse::App42GameResponse(pTarget,pSelector);
