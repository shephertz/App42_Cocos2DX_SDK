...
class GameService : public App42Service, public cocos2d::Node
{
...
public:
     ...
     *
     */
	void CreateGame(string gameName,string description, Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     *
     */
	void GetGamebyName(string gameName,Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
     ...
     *
     */
	void GetAllGames(Object* pTarget, cocos2d::SEL_CallFuncND pSelector);
