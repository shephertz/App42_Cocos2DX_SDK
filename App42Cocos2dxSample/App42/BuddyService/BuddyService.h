...
public:
     ...
     */
    void SendFriendRequest(const char* userName, const char* buddyName, const char* message, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetFriendRequest(const char* userName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void AcceptFriendRequest(const char* userName, const char* buddyName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void RejectFriendRequest(const char* userName, const char* buddyName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void CreateGroupByUser(const char* userName, const char* groupName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetAllFriends(const char* userName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void AddFriendsToGroup(const char* userName, const char* groupName, vector<string>friends, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void CheckedInGeoLocation(const char* userName, App42GeoPoint* point, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void GetFriendsByLocation(const char* userName,double latitude, double longitude, double maxDistance,int max, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetAllGroups(const char* userName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void GetAllFriendsInGroup(const char* userName, const char* ownerName, const char* groupName, const app42CallBack& pSelector);
     ...
     * @throws App42Exception
     */
    void BlockFriendRequest(const char* userName, const char* buddyName, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void BlockUser(const char* userName, const char* buddyName, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void UnblockUser(const char* userName, const char* buddyName, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void SendMessageToGroup(const char* userName, const char* ownerName, const char* groupName, const char* message, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void SendMessageToFriend(const char* userName, const char* buddyName, const char* message, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void SendMessageToFriends(const char* userName, const char* message, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void GetAllMessages(const char* userName, const app42CallBack& pSelector);
	...
	void GetAllMessagesFromBuddy(const char* userName, const char* buddyName, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void GetAllMessagesFromGroup(const char* userName, const char* ownerName, const char* groupName, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void UnFriend(const char* userName, const char* buddyName, const app42CallBack& pSelector);
	 ...
	 * @throws App42Exception
	 */
	void DeleteMessageById(const char* userName, const char* messageId, const app42CallBack& pSelector);
	...
	void DeleteMessageByIds(const char* userName, vector<string> messageIds, const app42CallBack& pSelector);
