...
bool TestUserService::init()
{
    ...
    float y_pos = visibleSize.height;
     ...
     * Create User
     */
    auto createUserLabel = LabelTTF::create("Create User", "Marker Felt", fontSize);
     ...
     */
    auto createUserWithRolesLabel = LabelTTF::create("CreateUserWithRoles", "Marker Felt", fontSize);
     ...
     * AssignRoles
     */
    auto assignRolesLabel = LabelTTF::create("AssignRoles", "Marker Felt", fontSize);
     ...
     * Authenticate User
     */
    auto authenticateUserLabel = LabelTTF::create("Authenticate User", "Marker Felt", fontSize);
     ...
     */
    auto authenticateUserViaEmailLabel = LabelTTF::create("AuthenticateUserViaEmail", "Marker Felt", fontSize);
     ...
     */
    auto getUserLabel = LabelTTF::create("Get User", "Marker Felt", fontSize);
     ...
     */
    auto getUserByEmailLabel = LabelTTF::create("GetUserByEmailId", "Marker Felt", fontSize);
     ...
     * Get All Users
     */
    auto getAllUserLabel = LabelTTF::create("GetAllUser", "Marker Felt", fontSize);
     ...
     */
    auto getAllUserByPagingLabel = LabelTTF::create("GetAllUserByPaging", "Marker Felt", fontSize);
     ...
     * Get All Users Count
     */
    auto getAllUsersCountLabel = LabelTTF::create("GetAllUsersCount", "Marker Felt", fontSize);
     ...
     * Lock User
     */
    auto lockUserLabel = LabelTTF::create("LockUser", "Marker Felt", fontSize);
     ...
     * UnLock User
     */
    auto unlockUserLabel = LabelTTF::create("UnLockUser", "Marker Felt", fontSize);
     ...
     * GetLockedUsers
     */
    auto getAllLockedUsersLabel = LabelTTF::create("GetLockedUsers", "Marker Felt", fontSize);
     ...
     */
    auto getLockedUsersPagingLabel = LabelTTF::create("GetLockedUsersByPaging", "Marker Felt", fontSize);
     ...
     * GetLockedUsersCount
     */
    auto getAllLockedUsersCountLabel = LabelTTF::create("GetLockedUsersCount", "Marker Felt", fontSize);
     ...
     * Update Email
     */
    auto updateEmailLabel = LabelTTF::create("UpdateEmail", "Marker Felt", fontSize);
     ...
     * Delete User
     */
    auto deleteUserLabel = LabelTTF::create("DeleteUser", "Marker Felt", fontSize);
     ...
     */
    auto deleteUserPermanentLabel = LabelTTF::create("DeleteUserPermanent", "Marker Felt", fontSize);
     ...
     */
    auto changePwdLabel = LabelTTF::create("ChangePassword", "Marker Felt", fontSize);
     ...
     * Reset User Password
     */
    auto resetPwdLabel = LabelTTF::create("ResetPassword", "Marker Felt", fontSize);
     ...
     */
    auto profileLabel = LabelTTF::create("Create/UpdateUserProfile", "Marker Felt", fontSize);
     ...
     */
    auto getUsersByProfileLabel = LabelTTF::create("GetUsersByProfile", "Marker Felt", fontSize);
     ...
     * LogOut
     */
    auto logoutLabel = LabelTTF::create("LogOut", "Marker Felt", fontSize);
     ...
     * GetRolesByUser
     */
    auto getRolesByUserLabel = LabelTTF::create("GetRolesByUser", "Marker Felt", fontSize);
     ...
     * GetUsersByRole
     */
    auto getUsersByRoleLabel = LabelTTF::create("GetUsersByRole", "Marker Felt", fontSize);
     ...
     * RevokeRole
     */
    auto revokeRoleLabel = LabelTTF::create("RevokeRole", "Marker Felt", fontSize);
     ...
     * RevokeAllRoles
     */
    auto revokeAllRolesLabel = LabelTTF::create("RevokeAllRoles", "Marker Felt", fontSize);
     ...
     * GetUsersByGroup
     */
    auto getUsersByGroupLabel = LabelTTF::create("GetUsersByGroup", "Marker Felt", fontSize);
     ...
     */
    auto createUserWithProfileLabel = LabelTTF::create("CreateUserWithProfile", "Marker Felt", fontSize);
     ...
     */
    auto createUserWithCustomDataLabel = LabelTTF::create("CreateUserWithCustomData", "Marker Felt", fontSize);
     ...
     */
    auto getUserWithCustomDataLabel = LabelTTF::create("GetUserWithCustomData", "Marker Felt", fontSize);
     ...
     */
    auto getAllUsersWithCustomDataLabel = LabelTTF::create("GetAllUsersWithCustomData", "Marker Felt", fontSize);
...
void TestUserService::createUser(Ref* pSender)
{
    ...
    const char* userName = "Nick243453232323erer";
    const char* pwd = "*******";
    const char* emailId = "Nick24345232323ffdfdfd2@shephertz.co.in";
