...
bool TestGameService::init()
{
     ...
     * Create Game
     */
    auto createGameLabel = LabelTTF::create("CreateGame", "Marker Felt", fontSize);
     ...
     * Get Game by Name
     */
    auto getGameLabel = LabelTTF::create("GetGameByName", "Marker Felt", fontSize);
     ...
     * Get All Games
     */
    auto getAllGamesLabel = LabelTTF::create("GetAllGames", "Marker Felt", fontSize);
     ...
     */
    auto getAllGamesByPagingLabel = LabelTTF::create("GetAllGamesByPaging", "Marker Felt", fontSize);
     ...
     * Get All Games Count
     */
    auto getAllGamesCountLabel = LabelTTF::create("GetAllGamesCount", "Marker Felt", fontSize);
