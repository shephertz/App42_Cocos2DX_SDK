...
bool TestRewardService::init()
{
     ...
     * Create Reward
     */
    auto createRewardLabel = LabelTTF::create("CreateReward", "Marker Felt", fontSize);
     ...
     * Get All Rewards
     */
    auto getAllRewardsLabel = LabelTTF::create("GetAllRewards", "Marker Felt", fontSize);
     ...
     */
    auto getAllRewardsByPagingLabel = LabelTTF::create("GetAllRewardsByPaging", "Marker Felt", fontSize);
     ...
     */
    auto getAllRewardsCountLabel = LabelTTF::create("GetAllRewardsCount", "Marker Felt", fontSize);
     ...
     * Earn Reward
     */
    auto earnRewardLabel = LabelTTF::create("EarnRewards", "Marker Felt", fontSize);
     ...
     * Redeem Reward
     */
    auto redeemRewardLabel = LabelTTF::create("RedeemRewards", "Marker Felt", fontSize);
     ...
     */
    auto getGameRewardPointsForUserLabel = LabelTTF::create("GetGameRewardPointsForUser", "Marker Felt", fontSize);
     ...
     * GetRewardByName
     */
    auto getRewardByNameLabel = LabelTTF::create("GetRewardByName", "Marker Felt", fontSize);
     ...
     */
    auto getTopNRewardEarnersLabel = LabelTTF::create("GetTopNRewardEarners", "Marker Felt", fontSize);
     ...
     * GetAllRewardsByUser
     */
    auto getAllRewardsByUserLabel = LabelTTF::create("GetAllRewardsByUser", "Marker Felt", fontSize);
     ...
     */
    auto getTopNRewardEarnersByGroupLabel = LabelTTF::create("GetTopNRewardEarnersByGroup", "Marker Felt", fontSize);
     ...
     */
    auto getUserRankingOnRewardLabel = LabelTTF::create("GetUserRankingOnReward", "Marker Felt", fontSize);
