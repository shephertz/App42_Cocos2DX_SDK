...
bool TestBuddyService::init()
{
     ...
     * SendFriendRequest
     */
    auto sendFrndRequestLabel = LabelTTF::create("SendFriendRequest", "Marker Felt", fontSize);
     ...
     * GetFriendRequest
     */
    auto getFriendRequestLabel = LabelTTF::create("GetFriendRequest", "Marker Felt", fontSize);
     ...
     * AcceptFriendRequest
     */
    auto acceptFriendRequestLabel = LabelTTF::create("AcceptFriendRequest", "Marker Felt", fontSize);
     ...
     * RejectFriendRequest
     */
    auto rejectFriendRequestLabel = LabelTTF::create("RejectFriendRequest", "Marker Felt", fontSize);
     ...
     * GetAllFriends
     */
    auto getAllFriendsLabel = LabelTTF::create("GetAllFriends", "Marker Felt", fontSize);
     ...
     * CreateGroup
     */
    auto createGroupLabel = LabelTTF::create("CreateGroup", "Marker Felt", fontSize);
     ...
     * AddFriendsToGroup
     */
    auto addFriendsToGroupLabel = LabelTTF::create("AddFriendsToGroup", "Marker Felt", fontSize);
     ...
     * GetAllGroup
     */
    auto getAllGroupLabel = LabelTTF::create("GetAllGroup", "Marker Felt", fontSize);
     ...
     */
    auto getAllFriendsOfUserLabel = LabelTTF::create("GetAllFriendsInGroup", "Marker Felt", fontSize);
     ...
     * BlockFriendRequest
     */
    auto blockFriendRequestLabel = LabelTTF::create("BlockFriendRequest", "Marker Felt", fontSize);
     ...
     * BlockUser
     */
    auto blockUserLabel = LabelTTF::create("BlockUser", "Marker Felt", fontSize);
     ...
     * UnblockUser
     */
    auto unblockUserLabel = LabelTTF::create("UnblockUser", "Marker Felt", fontSize);
    ...
    * SendMessageToGroup
    */
    auto sendMessageToGroupLabel = LabelTTF::create("SendMessageToGroup", "Marker Felt", fontSize);
     ...
     * SendMessageToFriend
     */
    auto sendMessageToFriendLabel = LabelTTF::create("SendMessageToFriend", "Marker Felt", fontSize);
     ...
     */
    auto sendMessageToFriendsLabel = LabelTTF::create("SendMessageToFriends", "Marker Felt", fontSize);
     ...
     * GetAllMessages
     */
    auto getAllMessagesLabel = LabelTTF::create("GetAllMessages", "Marker Felt", fontSize);
     ...
     */
    auto getAllMessagesFromBuddyLabel = LabelTTF::create("GetAllMessagesFromBuddy", "Marker Felt", fontSize);
     ...
     */
    auto getAllMessagesFromGroupLabel = LabelTTF::create("GetAllMessagesFromGroup", "Marker Felt", fontSize);
     ...
     * UnFriend
     */
    auto unFriendLabel = LabelTTF::create("UnFriend", "Marker Felt", fontSize);
     ...
     * DeleteMessageById
     */
    auto deleteMessageByIdLabel = LabelTTF::create("DeleteMessageById", "Marker Felt", fontSize);
     ...
     * DeleteMessageByIds
     */
    auto deleteMessageByIdsLabel = LabelTTF::create("DeleteMessageByIds", "Marker Felt", fontSize);
     ...
     */
    auto checkedInGeoLocationLabel = LabelTTF::create("CheckedInGeoLocation", "Marker Felt", fontSize);
     ...
     */
    auto getFriendsByLocationLabel = LabelTTF::create("GetFriendsByLocation", "Marker Felt", fontSize);
