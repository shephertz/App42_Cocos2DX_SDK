...
bool TestAvatarService::init()
{
     ...
     * CreateAvatar
     */
    auto createAvatarLabel = LabelTTF::create("CreateAvatar", "Marker Felt", fontSize);
     ...
     */
    auto createAvatarFromFileDataLabel = LabelTTF::create("CreateAvatarFromFileData", "Marker Felt", fontSize);
     ...
     */
    auto createAvatarFromFacebookLabel = LabelTTF::create("CreateAvatarFromFacebook", "Marker Felt", fontSize);
     ...
     */
    auto createAvatarFromWebUrlLabel = LabelTTF::create("CreateAvatarFromWebUrl", "Marker Felt", fontSize);
     ...
     * GetAvatarByName
     */
    auto getAvatarByNameLabel = LabelTTF::create("GetAvatarByName", "Marker Felt", fontSize);
     ...
     * GetAllAvatars
     */
    auto getAllAvatarsLabel = LabelTTF::create("GetAllAvatars", "Marker Felt", fontSize);
    getAvatarByNameLabel->setColor(Color3B::WHITE);
     ...
     * GetCurrentAvatar
     */
    auto getCurrentAvatarLabel = LabelTTF::create("GetCurrentAvatar", "Marker Felt", fontSize);
     ...
     * ChangeCurrentAvatar
     */
    auto changeCurrentAvatarLabel = LabelTTF::create("ChangeCurrentAvatar", "Marker Felt", fontSize);
