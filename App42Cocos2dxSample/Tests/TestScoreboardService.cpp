...
bool TestScoreboardService::init()
{
     ...
     * SaveUserScore
     */
    auto saveUserScoreLabel = LabelTTF::create("SaveUserScore", "Marker Felt", fontSize);
     ...
     * Edit Score
     */
    auto editScoreLabel = LabelTTF::create("Edit Score", "Marker Felt", fontSize);
     ...
     * GetScoresByUser
     */
    auto getScoresByUserLabel = LabelTTF::create("GetScoresByUser", "Marker Felt", fontSize);
     ...
     */
    auto getLowestScoreByUserLabel = LabelTTF::create("GetLowestScoreByUser", "Marker Felt", fontSize);
     ...
     */
    auto getHighestScoreByUserLabel = LabelTTF::create("GetHighestScoreByUser", "Marker Felt", fontSize);
     ...
     */
    auto getAverageScoreByUserLabel = LabelTTF::create("GetAverageScoreByUser", "Marker Felt", fontSize);
     ...
     * GetLastScoreByUser
     */
    auto getLastScoreByUserLabel = LabelTTF::create("GetLastScoreByUser", "Marker Felt", fontSize);
     ...
     * GetLastGameScore
     */
    auto getLastGameScoreLabel = LabelTTF::create("GetLastGameScore", "Marker Felt", fontSize);
     ...
     * GetTopRankings
     */
    auto getTopRankingsLabel = LabelTTF::create("GetTopRankings", "Marker Felt", fontSize);
     ...
     */
    auto getTopRankersByGroupLabel = LabelTTF::create("GetTopRankersByGroup", "Marker Felt", fontSize);
     ...
     */
    auto getTopRankingsByGroupLabel = LabelTTF::create("GetTopRankingsByGroup", "Marker Felt", fontSize);
     ...
     * GetTopNRankings
     */
    auto getTopNRankingsLabel = LabelTTF::create("GetTopNRankings", "Marker Felt", fontSize);
     ...
     */
    auto getUsersWithScoreRangeLabel = LabelTTF::create("GetUsersWithScoreRange", "Marker Felt", fontSize);
     ...
     */
    auto getTopRankingsInDateRangeLabel = LabelTTF::create("GetTopRankingsInDateRange", "Marker Felt", fontSize);
     ...
     * GetTopNRankers
     */
    auto getTopNRankersLabel = LabelTTF::create("GetTopNRankers", "Marker Felt", fontSize);
     ...
     */
    auto getTopNRankersBySortingLabel = LabelTTF::create("GetTopNRankersBySorting", "Marker Felt", fontSize);
     ...
     */
    auto getTopNRankersInDateRangeLabel = LabelTTF::create("GetTopNRankersInDateRange", "Marker Felt", fontSize);
     ...
     * GetUserRanking
     */
    auto getUserRankingLabel = LabelTTF::create("GetUserRanking", "Marker Felt", fontSize);
     ...
     */
    auto getTopNTargetRankersLabel = LabelTTF::create("GetTopNTargetRankers", "Marker Felt", fontSize);
     ...
     */
    auto getTopNRankersFromFacebookLabel = LabelTTF::create("GetTopNRankersFromFacebook", "Marker Felt", fontSize);
     ...
     */
    auto getTopNRankersFromFacebookInDateRangeLabel = LabelTTF::create("GetTopNRankersFromFacebookInDateRange", "Marker Felt", fontSize);
     ...
     * SaveCustomScore
     */
    auto saveCustomScoreLabel = LabelTTF::create("SaveCustomScore", "Marker Felt", fontSize);
     ...
     * FetchCustomScore
     */
    auto fetchCustomScoreLabel = LabelTTF::create("FetchCustomScore", "Marker Felt", fontSize);
...
void TestScoreboardService::saveUserScore(Ref *sender)
{
    ...
    int score = 400;
    string userName = "汉语";
    string userN = base64_encode((unsigned char const*)userName.c_str(), (int)userName.length());
...
void TestScoreboardService::saveCustomUserScore(Ref* sender)
{
    ...
    App42Object *object = new App42Object();
    object->setObject("displayName", "Shephertz");// key-value pair
    object->setObject("level", 2);
    scoreBoardService->AddCustomScore(object, collectionName);

    const char* fbId = "App42Team";
    int score = 400;
