...
bool TestPushNotificationService::init()
{
     ...
     */
    auto registerDeviceTokenLabel = LabelTTF::create("RegisterDevice", "Marker Felt", fontSize);
     ...
     * Create Channel
     */
    auto createChannelLabel = LabelTTF::create("CreateChannel", "Marker Felt", fontSize);
     ...
     */
    auto subscribeToChannelLabel = LabelTTF::create("SubscribeToChannel", "Marker Felt", fontSize);
     ...
     */
    auto subscribeDeviceToChannelLabel = LabelTTF::create("SubscribeDeviceToChannel", "Marker Felt", fontSize);
     ...
     */
    auto unsubscribeToChannelLabel = LabelTTF::create("UnsubscribeToChannel", "Marker Felt", fontSize);
     ...
     */
    auto unsubscribeDeviceToChannelLabel = LabelTTF::create("UnsubscribeDeviceToChannel", "Marker Felt", fontSize);
     ...
     */
    auto deleteDeviceTokenLabel = LabelTTF::create("DeleteDeviceToken", "Marker Felt", fontSize);
     ...
     */
    auto deleteAllDevicesLabel = LabelTTF::create("DeleteAllDevices", "Marker Felt", fontSize);
     ...
     *  Unsubscribe device
     */
    auto unsubscribeDeviceLabel = LabelTTF::create("UnsubscribeDevice", "Marker Felt", fontSize);
     ...
     *  Resubscribe device
     */
    auto resubscribeDeviceLabel = LabelTTF::create("ResubscribeDevice", "Marker Felt", fontSize);
     ...
     */
    auto sendPushToUserLabel = LabelTTF::create("SendPushMessageToUser", "Marker Felt", fontSize);
     ...
     *  SendPushJsonToUser
     */
    auto sendPushJsonToUserLabel = LabelTTF::create("SendPushJsonToUser", "Marker Felt", fontSize);
     ...
     *  SendPushToAll
     */
    auto sendPushToAllLabel = LabelTTF::create("SendPushToAll", "Marker Felt", fontSize);
     ...
     *  SendPushToAllByType
     */
    auto sendPushToAllByTypeLabel = LabelTTF::create("SendPushToAllByType", "Marker Felt", fontSize);
     ...
     *  SendPushToGroup
     */
    auto sendPushToGroupLabel = LabelTTF::create("SendPushToGroup", "Marker Felt", fontSize);
     ...
     */
    auto sendPushToTargetUsersLabel = LabelTTF::create("SendPushToTargetUsers", "Marker Felt", fontSize);
     ...
     */
    auto scheduleMessageToUserLabel = LabelTTF::create("ScheduleMessageToUser", "Marker Felt", fontSize);
     ...
     */
    auto sendPushMeassageToChannelLabel = LabelTTF::create("SendPushMeassageToChannel", "Marker Felt", fontSize);
     ...
     */
    auto sendPushMeassageToDeviceLabel = LabelTTF::create("SendPushMeassageToDevice", "Marker Felt", fontSize);
     ...
     */
    auto updatePushBadgeForDeviceLabel = LabelTTF::create("UpdatePushBadgeForDevice", "Marker Felt", fontSize);
     ...
     *  UpdatePushBadgeForDevice
     */
    auto updatePushBadgeForUserLabel = LabelTTF::create("UpdatePushBadgeForUser", "Marker Felt", fontSize);
     ...
     *  ClearAllBadgeCount
     */
    auto clearAllBadgeCountLabel = LabelTTF::create("ClearAllBadgeCount", "Marker Felt", fontSize);
