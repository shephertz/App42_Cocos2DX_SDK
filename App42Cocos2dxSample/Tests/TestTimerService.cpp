...
bool TestTimerService::init()
{
     ...
     * CreateOrUpdateTimer
     */
    auto createOrUpdateTimerLabel = LabelTTF::create("CreateOrUpdateTimer", "Marker Felt", fontSize);
     ...
     * StartTimer
     */
    auto startTimerLabel = LabelTTF::create("StartTimer", "Marker Felt", fontSize);
