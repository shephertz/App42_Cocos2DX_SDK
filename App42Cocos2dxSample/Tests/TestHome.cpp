...
bool TestHome::init()
{
    ...
    *****************************/
     ...
     * User Service Test
     */
    auto userServiceLabel = LabelTTF::create("User Service", "Marker Felt", fontSize);
     ...
     */
    auto storageServiceLabel = LabelTTF::create("Storage Service", "Marker Felt", fontSize);
     ...
     * Push Service Test
     */
    auto pushServiceLabel = LabelTTF::create("Push Service", "Marker Felt", fontSize);
     ...
     * Game Service Test
     */
    auto gameServiceLabel = LabelTTF::create("Game Service", "Marker Felt", fontSize);
     ...
     */
    auto scoreboardServiceLabel = LabelTTF::create("Scoreboard Service", "Marker Felt", fontSize);
     ...
     * Reward Service Test
     */
    auto rewardServiceLabel = LabelTTF::create("Reward Service", "Marker Felt", fontSize);
     ...
     * Email Service Test
     */
    auto emailServiceLabel = LabelTTF::create("Email Service", "Marker Felt", fontSize);
     ...
     */
    auto customCodeServiceLabel = LabelTTF::create("CustomCode Service", "Marker Felt", fontSize);
     ...
     * Upload Service Test
     */
    auto uploadServiceLabel = LabelTTF::create("Upload Service", "Marker Felt", fontSize);
     ...
     * Social Service Test
     */
    auto socialServiceLabel = LabelTTF::create("Social Service", "Marker Felt", fontSize);
     ...
     * Avatar Service Test
     */
    auto avatarServiceLabel = LabelTTF::create("Avatar Service", "Marker Felt", fontSize);
     ...
     */
    auto sessionServiceLabel = LabelTTF::create("Session Service", "Marker Felt", fontSize);
     ...
     * Buddy Service Test
     */
    auto buddyServiceLabel = LabelTTF::create("Buddy Service", "Marker Felt", fontSize);
     ...
     * Timer Service Test
     */
    auto timerServiceLabel = LabelTTF::create("Timer Service", "Marker Felt", fontSize);
     ...
     * Geo Service Test
     */
    auto geoServiceLabel = LabelTTF::create("Geo Service", "Marker Felt", fontSize);
