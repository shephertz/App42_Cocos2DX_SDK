...
bool TestEmailService::init()
{
     ...
     * ConfigureMail
     */
    auto configureMailLabel = LabelTTF::create("ConfigureMail", "Marker Felt", fontSize);
     ...
     * RemoveConfiguration
     */
    auto removeConfigurationLabel = LabelTTF::create("RemoveConfiguration", "Marker Felt", fontSize);
     ...
     * GetConfigurations
     */
    auto getConfigurationLabel = LabelTTF::create("GetConfigurations", "Marker Felt", fontSize);
     ...
     * SendMail
     */
    auto sendMailLabel = LabelTTF::create("SendMail", "Marker Felt", fontSize);
