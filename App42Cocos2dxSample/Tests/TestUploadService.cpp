...
bool TestUploadService::init()
{
     ...
     * UploadFile
     */
    auto uploadFileLabel = LabelTTF::create("UploadFile", "Marker Felt", fontSize);
     ...
     * UploadFileData
     */
    auto uploadFileDataLabel = LabelTTF::create("UploadFileData", "Marker Felt", fontSize);
     ...
     * GetAllFiles
     */
    auto getAllFilesLabel = LabelTTF::create("GetAllFiles", "Marker Felt", fontSize);
     ...
     * GetAllFilesCount
     */
    auto getAllFilesCountLabel = LabelTTF::create("GetAllFilesCount", "Marker Felt", fontSize);
     ...
     * GetAllFilesByPaging
     */
    auto getAllFilesByPagingLabel = LabelTTF::create("GetAllFilesByPaging", "Marker Felt", fontSize);
     ...
     * GetFileByUser
     */
    auto getFileByUserLabel = LabelTTF::create("GetFileByUser", "Marker Felt", fontSize);
     ...
     * GetAllFilesByUser
     */
    auto getAllFilesByUserLabel = LabelTTF::create("GetAllFilesByUser", "Marker Felt", fontSize);
     ...
     */
    auto getAllFilesByUserByPagingLabel = LabelTTF::create("GetAllFilesByUserByPaging", "Marker Felt", fontSize);
     ...
     */
    auto getAllFilesCountByUserLabel = LabelTTF::create("GetAllFilesCountByUser", "Marker Felt", fontSize);
     ...
     * GetFileByName
     */
    auto getFileByNameLabel = LabelTTF::create("GetFileByName", "Marker Felt", fontSize);
     ...
     * RemoveFileByUser
     */
    auto removeFileByUserLabel = LabelTTF::create("RemoveFileByUser", "Marker Felt", fontSize);
     ...
     */
    auto removeAllFilesByUserLabel = LabelTTF::create("RemoveAllFilesByUser", "Marker Felt", fontSize);
     ...
     * RemoveFileByName
     */
    auto removeFileByNameLabel = LabelTTF::create("RemoveFileByName", "Marker Felt", fontSize);
     ...
     * RemoveAllFiles
     */
    auto removeAllFilesLabel = LabelTTF::create("RemoveAllFiles", "Marker Felt", fontSize);
     ...
     * GetFilesCountByType
     */
    auto getFilesCountByTypeLabel = LabelTTF::create("GetFilesCountByType", "Marker Felt", fontSize);
     ...
     * GetFilesByType
     */
    auto getFilesByTypeLabel = LabelTTF::create("GetFilesByType", "Marker Felt", fontSize);
     ...
     */
    auto getFilesByTypeByPagingLabel = LabelTTF::create("GetFilesByTypeByPaging", "Marker Felt", fontSize);
     ...
     * UploadFileForUser
     */
    auto uploadFileForUserLabel = LabelTTF::create("UploadFileForUser", "Marker Felt", fontSize);
     ...
     */
    auto uploadFileDataForUserLabel = LabelTTF::create("UploadFileDataForUser", "Marker Felt", fontSize);
     ...
     * GrantAccess
     */
    auto grantAccessLabel = LabelTTF::create("GrantAccess", "Marker Felt", fontSize);
     ...
     * RevokeAccess
     */
    auto revokeAccessLabel = LabelTTF::create("RevokeAccess", "Marker Felt", fontSize);
