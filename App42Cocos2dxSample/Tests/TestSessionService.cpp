...
bool TestSessionService::init()
{
     ...
     * GetSession
     */
    auto getSessionLabel = LabelTTF::create("GetSession", "Marker Felt", fontSize);
     ...
     */
    auto getSessionWithCreateFlagLabel = LabelTTF::create("GetSessionWithCreateFlag", "Marker Felt", fontSize);
     ...
     * Invalidate
     */
    auto invalidateLabel = LabelTTF::create("Invalidate", "Marker Felt", fontSize);
     ...
     * SetAttribute
     */
    auto setAttributeLabel = LabelTTF::create("SetAttribute", "Marker Felt", fontSize);
     ...
     * GetAttribute
     */
    auto getAttributeLabel = LabelTTF::create("GetAttribute", "Marker Felt", fontSize);
     ...
     * GetAllAttribute
     */
    auto getAllAttributeLabel = LabelTTF::create("GetAllAttribute", "Marker Felt", fontSize);
     ...
     * RemoveAttribute
     */
    auto removeAttributeLabel = LabelTTF::create("RemoveAttribute", "Marker Felt", fontSize);
     ...
     * RemoveAllAttribute
     */
    auto removeAllAttributeLabel = LabelTTF::create("RemoveAllAttribute", "Marker Felt", fontSize);
